...
namespace Barraroot\FilamentMaterialTheme\Console;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\File;

class FilamentMaterialThemeInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'filament-material-theme:install';
     ...
     * @var string
     */
    protected $description = 'Install Filament Material theme assets';
    ...
    public function handle()
    {
        ...
        $this->info('Filament Material Theme installed successfully!');
